...
root = Tk()
root.title("Random Country Capitals")
...
btn = Button(root, text = "Display Country & Capital Name", command = input_data, bg = "green", fg = "white")
btn.place(relx = 0.5, rely = 0.4, anchor = CENTER)

country_list.place(relx = 0.5, rely = 0.5, anchor = CENTER)
capital_list.place(relx = 0.5, rely = 0.6, anchor = CENTER)
    
btn1 = Button(root, text = "Display Country & Capital Name Randomly", command = random1, bg = "purple", fg = "white")
